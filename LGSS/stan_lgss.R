...
fit_stan_multi_lgss_whittle <- whittle_lgss_model$sample(
  whittle_lgss_data,
  chains = 1,
...
hmcw_results <- list(draws = fit_stan_multi_lgss_whittle$draws(variables = c("phi", "sigma_eta", "sigma_eps")),
                     time = fit_stan_multi_lgss_whittle$time)
