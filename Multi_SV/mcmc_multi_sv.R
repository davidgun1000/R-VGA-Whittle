...
## Extract samples
post_samples_phi <- lapply(post_samples, function(x) x$Phi) #post_samples_theta[, 1]
post_samples_sigma_eta <- lapply(post_samples, function(x) x$Sigma_eta) #post_samples_theta[, 2]
...
post_samples_phi_11 <- lapply(post_samples_phi, function(x) x[1,1])
post_samples_phi_12 <- lapply(post_samples_phi, function(x) x[1,2])
post_samples_phi_21 <- lapply(post_samples_phi, function(x) x[2,1])
post_samples_phi_22 <- lapply(post_samples_phi, function(x) x[2,2])

mcmc.post_samples_phi_11 <- as.mcmc(unlist(post_samples_phi_11[-(1:burn_in)]))
mcmc.post_samples_phi_12 <- as.mcmc(unlist(post_samples_phi_12[-(1:burn_in)]))
mcmc.post_samples_phi_21 <- as.mcmc(unlist(post_samples_phi_21[-(1:burn_in)]))
mcmc.post_samples_phi_22 <- as.mcmc(unlist(post_samples_phi_22[-(1:burn_in)]))

post_samples_sigma_eta_11 <- lapply(post_samples_sigma_eta, function(x) x[1,1])
post_samples_sigma_eta_12 <- lapply(post_samples_sigma_eta, function(x) x[1,2])
post_samples_sigma_eta_21 <- lapply(post_samples_sigma_eta, function(x) x[2,1])
post_samples_sigma_eta_22 <- lapply(post_samples_sigma_eta, function(x) x[2,2])

mcmc.post_samples_sigma_eta_11 <- as.mcmc(unlist(post_samples_sigma_eta_11[-(1:burn_in)]))
mcmc.post_samples_sigma_eta_12 <- as.mcmc(unlist(post_samples_sigma_eta_12[-(1:burn_in)]))
mcmc.post_samples_sigma_eta_21 <- as.mcmc(unlist(post_samples_sigma_eta_21[-(1:burn_in)]))
mcmc.post_samples_sigma_eta_22 <- as.mcmc(unlist(post_samples_sigma_eta_22[-(1:burn_in)]))


par(mfrow = c(2,2))
traceplot(mcmc.post_samples_phi_11, main = "Trace plot for MCMC with exact likelihood")
abline(h = phi11, col = "red", lty = 2)
traceplot(mcmc.post_samples_phi_12, main = "Trace plot for MCMC with exact likelihood")
abline(h = phi12, col = "red", lty = 2)
traceplot(mcmc.post_samples_phi_21, main = "Trace plot for MCMC with exact likelihood")
abline(h = phi21, col = "red", lty = 2)
traceplot(mcmc.post_samples_phi_22, main = "Trace plot for MCMC with exact likelihood")
abline(h = phi22, col = "red", lty = 2)

traceplot(mcmc.post_samples_sigma_eta_11, main = "Trace plot for MCMC with exact likelihood")
abline(h = Sigma_eta[1,1], col = "red", lty = 2)
traceplot(mcmc.post_samples_sigma_eta_12, main = "Trace plot for MCMC with exact likelihood")
abline(h = Sigma_eta[1,2], col = "red", lty = 2)
traceplot(mcmc.post_samples_sigma_eta_21, main = "Trace plot for MCMC with exact likelihood")
abline(h = Sigma_eta[2,1], col = "red", lty = 2)
traceplot(mcmc.post_samples_sigma_eta_22, main = "Trace plot for MCMC with exact likelihood")
abline(h = Sigma_eta[2,2], col = "red", lty = 2)


plot(density(mcmc.post_samples_phi_11), col = "blue", main = "phi_11")
abline(v = phi11, lty = 2)
plot(density(mcmc.post_samples_phi_12), col = "blue", main = "phi_12")
abline(v = phi12, lty = 2)
plot(density(mcmc.post_samples_phi_21), col = "blue", main = "phi_21")
abline(v = phi21, lty = 2)
plot(density(mcmc.post_samples_phi_22), col = "blue", main = "phi_22")
abline(v = phi22, lty = 2)

plot(density(mcmc.post_samples_sigma_eta_11), col = "blue", main = "sigma_eta_11")
abline(v = Sigma_eta[1,1], lty = 2)
plot(density(mcmc.post_samples_sigma_eta_12), col = "blue", main = "sigma_eta_12")
abline(v = Sigma_eta[1,2], lty = 2)
plot(density(mcmc.post_samples_sigma_eta_21), col = "blue", main = "sigma_eta_21")
abline(v = Sigma_eta[2,1], lty = 2)
plot(density(mcmc.post_samples_sigma_eta_22), col = "blue", main = "sigma_eta_22")
