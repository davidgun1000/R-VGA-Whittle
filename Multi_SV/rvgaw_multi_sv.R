...
post_samples_phi_11 <- unlist(lapply(post_samples_Phi, function(x) x[1,1]))
post_samples_phi_12 <- unlist(lapply(post_samples_Phi, function(x) x[1,2]))
post_samples_phi_21 <- unlist(lapply(post_samples_Phi, function(x) x[2,1]))
post_samples_phi_22 <- unlist(lapply(post_samples_Phi, function(x) x[2,2]))

post_samples_sigma_eta_11 <- unlist(lapply(post_samples_Sigma_eta, function(x) x[1,1]))
post_samples_sigma_eta_12 <- unlist(lapply(post_samples_Sigma_eta, function(x) x[1,2]))
post_samples_sigma_eta_21 <- unlist(lapply(post_samples_Sigma_eta, function(x) x[2,1]))
post_samples_sigma_eta_22 <- unlist(lapply(post_samples_Sigma_eta, function(x) x[2,2]))

par(mfrow = c(2,2))
plot(density(post_samples_phi_11), col = "blue", main = "phi_11")
abline(v = phi11, lty = 2)
plot(density(post_samples_phi_12), col = "blue", main = "phi_12")
abline(v = phi12, lty = 2)
plot(density(post_samples_phi_21), col = "blue", main = "phi_21")
abline(v = phi21, lty = 2)
plot(density(post_samples_phi_22), col = "blue", main = "phi_22")
abline(v = phi22, lty = 2)

plot(density(post_samples_sigma_eta_11), col = "blue", main = "sigma_eta_11")
abline(v = Sigma_eta[1,1], lty = 2)
plot(density(post_samples_sigma_eta_12), col = "blue", main = "sigma_eta_12")
abline(v = Sigma_eta[1,2], lty = 2)
plot(density(post_samples_sigma_eta_21), col = "blue", main = "sigma_eta_21")
abline(v = Sigma_eta[2,1], lty = 2)
plot(density(post_samples_sigma_eta_22), col = "blue", main = "sigma_eta_22")
